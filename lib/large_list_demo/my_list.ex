defmodule LargeListDemo.MyList do
  @moduledoc """
  The MyList context.
  """
  ...
  def list_records(page: page, per_page: per_page) do
    Repo.all(from record in Record, offset: ^(page * per_page), limit: ^per_page)
  end

  def count_records do
    Repo.one(from record in Record, select: count(record.id))
  end
